    ...
    for (int i = 0; i<map.length; i++) {
        char seat_at_position = [map characterAtIndex:i];
         ...
         if (seat_at_position == 'E') {
            [self createSeatButtonWithPosition:initial_seat_x and:initial_seat_y isAvailable:FALSE isDisabled:TRUE andConditionString:@"E" andTag:i];
            initial_seat_x += 1;
            
        }else if (seat_at_position == 'A') {
            [self createSeatButtonWithPosition:initial_seat_x and:initial_seat_y isAvailable:TRUE isDisabled:FALSE andConditionString:@"A" andTag:i];
            initial_seat_x += 1;
            
        }else if (seat_at_position == 'L') {
            [self createSeatButtonWithPosition:initial_seat_x and:initial_seat_y isAvailable:TRUE isDisabled:FALSE andConditionString:@"L" andTag:i];
            initial_seat_x += 1;
            
        } else if (seat_at_position == 'D') {
            [self createSeatButtonWithPosition:initial_seat_x and:initial_seat_y isAvailable:TRUE isDisabled:TRUE andConditionString:@"D" andTag:i];
            initial_seat_x += 1;
            
        } else if (seat_at_position == 'U') {
            [self createSeatButtonWithPosition:initial_seat_x and:initial_seat_y isAvailable:FALSE isDisabled:FALSE andConditionString:@"U" andTag:i];
            initial_seat_x += 1;
